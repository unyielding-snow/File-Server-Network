...
int main(int argc, char* argv[]) {
    ...
    status = fs_delete("justin", "/dir/dir2.1");
    std::cout << "User Justin: " << status << '\n';

    status = fs_delete("justin", "/dir/dir2");
    std::cout << "User Justin: " << status << '\n';

    // Continuos Delete
    status = fs_delete("justin", "/dir/dir2/dir3");    
    std::cout << "Delete Justin : " << status << "\n";
    ...
    status = fs_delete("justin", "/dir");    
    std::cout << "Delete Justin: " << status << "\n";

    status = fs_delete("justin", "/");    
    std::cout << "Delete Justin: " << status << "\n";
